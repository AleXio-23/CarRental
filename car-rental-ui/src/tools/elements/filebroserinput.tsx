...
function FileBrowser({
  ...
  setImageBase: Dispatch<
    SetStateAction<{ base64: string; url: string; filename: string } | null>
  >;
}) {
  ...
  return (
    <SelectorArea>
      ...
      />
      <InputVisibleSpan selectedImageName={selectedFileName} />
    </SelectorArea>
  );
}
...
const InputVisibleSpan = styled.span<{ selectedImageName?: string }>`
  position: absolute;
  top: 0;
  right: 0;
  left: 0;
